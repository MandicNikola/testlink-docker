...
Ako smo ranije pokretali aplikaciju i menjali podatke, pokretanjem ove komande obrišaćemo sav sadržaj (volumes, kontejnere, mreže...) koji je povezan sa `docker-compose.yml`.
